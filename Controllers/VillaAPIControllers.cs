...
namespace MagicVilla.Controllers
{
    ...
    {
        private readonly ILogger<VillaAPIControllers> logger;

        public VillaAPIControllers(ILogger<VillaAPIControllers> _logger)
        {
            logger = _logger;
        }
        ...
        {
            logger.LogInformation("Getting villa information");
